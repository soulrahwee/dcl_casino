...
screenStream2.addComponent(new Transform({ position: new Vector3(-27, 2, 44), rotation: Quaternion.Euler(0, 90, 0) }))
engine.addEntity(screenStream2)

const screenTransform2 = new Entity()
screenTransform2.addComponent(new Transform({ position: new Vector3(0, 2, 0) }))
...
screen2.addComponent(new Transform({ scale: new Vector3(13.60, 6, 6) }))
